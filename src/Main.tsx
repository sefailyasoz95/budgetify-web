...
const Main: React.FC = () => {
	return (
		<motion.div
			...
			className='w-11/12 min-h-[95vh] overflow-x-hidden flex flex-col md:w-3/5 xl:md:w-2/5 rounded-lg shadow-gray-700 dark:shadow-gray-500 shadow-lg bg-colors-opposite'>
			<Header />
